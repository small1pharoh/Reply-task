...
class removeUserHasDemandTest {
	...
	static void setUpBeforeClass() throws Exception {
		try {  
	        ...
	        fh = new FileHandler("removeUserHasDemandTest.log");  
	...
	void test() {
		...
		logger.info("###################################################");
		logger.info("######   Remove user has a demand  ################");
		logger.info("###################################################");
		...
		assertEquals(output,"Can not delet user who has a demand");
		logger.info("I can not remove my account. I have an error Message ((Can not delet user who has a demand))");
		logger.info("test Pass");
		logger.info("--------------------------------------------------------------------");
